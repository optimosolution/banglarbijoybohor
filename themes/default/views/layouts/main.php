                    ...
                    <ul class="nav navbar-nav">
                        <li class="dropdown active">
                            ...
                            <ul class="dropdown-menu">
                                <li><?php echo CHtml::link('Executive Committee', array('content/index', 'id' => 2), array('class' => '')); ?></li>
                                <li><?php echo CHtml::link('Advisers', array('content/index', 'id' => 5), array('class' => '')); ?></li>
                            </ul>
                        </li>     
                        <li class="hidden-sm hidden-md">
                            <?php echo CHtml::link('History', array('content/view', 'id' => 3), array('class' => '')); ?>
                        </li>
                        <li class="hidden-sm hidden-md">
                            <?php echo CHtml::link('Press Releases', array('content/index', 'id' => 3), array('class' => '')); ?>
                        </li>
                        <li class="hidden-sm hidden-md">
                            <?php echo CHtml::link('Organizational', array('content/index', 'id' => 6), array('class' => '')); ?>
                        </li>
                        <li class="hidden-sm hidden-md">
                            <?php echo CHtml::link('Events', array('content/index', 'id' => 7), array('class' => '')); ?>
                        </li>
                        <li class="hidden-sm hidden-md">
                            <?php echo CHtml::link('FAQs', array('content/index', 'id' => 4), array('class' => '')); ?>
                        </li>
                        <li class="dropdown">
                            <?php echo CHtml::link('Pictures <b class="caret"></b>', '#', array('class' => 'dropdown-toggle', 'data-toggle' => 'dropdown')); ?>
                            <ul class="dropdown-menu">
                                <?php $this->get_gallery_category(1); ?>
                            </ul>
                        </li>
                        <li class="hidden-sm hidden-md">
                            <?php echo CHtml::link('Videos', array('video/index'), array('class' => '')); ?>
                        </li>
                        <li class="hidden-sm hidden-md">
                            <?php echo CHtml::link('Contact', array('site/contact'), array('class' => '')); ?>
                        </li>
                    </ul>
                </div>
            </div>
                    ...
                    <div class="col-sm-4">
                        ...
                        <div class="content">
                            <p>
                                ...
                                Email: <a href="#">info@banglarbijoybohor.org</a>
                            </p>
                        </div>
                    </div>
                    <!-- Social icons  -->
