    ...
    public function get_latest_updates($catid) {
        ...
        foreach ($array as $key => $values) {
            ...
            if ((is_file($filePath)) && (file_exists($filePath))) {
                echo CHtml::image(Yii::app()->baseUrl . '/uploads/profile_picture/' . $values['profile_picture'], 'Picture', array('alt' => $values['title'], 'class' => 'media-object', 'title' => $values['title'], 'style' => 'width:75px;'));
            } else {
                echo CHtml::image(Yii::app()->baseUrl . '/uploads/profile_picture/noimage.jpg', 'Picture', array('alt' => $values['title'], 'class' => 'media-object', 'title' => $values['title'], 'style' => 'width:75px;'));
            }
            echo '</a>';
